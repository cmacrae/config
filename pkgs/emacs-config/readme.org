...
- Make sure the popup gets out of the way when it's not needed
...
(use-package dimmer
  ...
  :custom
  (dimmer-buffer-exclusion-regexps '("^ \\*corfu-popupinfo\\*$"))
  :config
...
#+BEGIN_SRC emacs-lisp
;; (use-package copilot
;;   :hook (after-init . global-copilot-mode)
;;   :bind
;;   (:map company-mode-map
;;     ("<down>"       . cm/copilot-next-completion)
;;     ("<up>"         . cm/copilot-previous-completion)
;;     ("<right>"      . cm/copilot-accept-completion-by-line)
;;     ("<left>"       . cm/copilot-accept-completion-by-word)
;;     ("TAB"          . cm/copilot-accept-completion)
;;     ("<tab>"        . cm/copilot-accept-completion))
...
;;   (defun cm/copilot-accept-completion ()
;;     (interactive)
;;     (or (copilot-accept-completion)
;;         (company-indent-or-complete-common nil)))

;;   (defun cm/copilot-next-completion ()
;;     (interactive)
;;     (or (copilot-next-completion)
;;         (company-select-next-if-tooltip-visible-or-complete-selection nil)))

;;   (defun cm/copilot-previous-completion ()
;;     (interactive)
;;     (or (copilot-previous-completion)
;;         (company-select-previous-or-abort nil)))

;;   (defun cm/copilot-accept-completion-by-line ()
;;     (interactive)
;;     (or (copilot-accept-completion-by-line)
;;         (company-indent-or-complete-common nil)))

;;   (defun cm/copilot-accept-completion-by-word ()
;;     (interactive)
;;     (or (copilot-accept-completion-by-word)
;;         (company-indent-or-complete-common nil)))

;;   (defun cm/no-copilot-mode ()
;;     "Helper for `cm/no-copilot-modes'."
;;     (copilot-mode -1))

;;   (defvar cm/no-copilot-modes '(shell-mode
...
;;   (defun cm/copilot-disable-predicate ()
;;     "When copilot should not automatically show completions."
;;     (or (member major-mode cm/no-copilot-modes)
;;         (company--active-p)))

;;   (add-to-list 'copilot-disable-predicates #'cm/copilot-disable-predicate)

;;   (defun cm/copilot-quit ()
...
;;   (advice-add 'keyboard-quit :before #'cm/copilot-quit))
#+END_SRC
*** ChatGPT
