...
(use-package vertico
  :ensure nil
  :load-path "~/src/github.com/aaronjensen/vertico"
...
It includes switching between light/dark themes for use with mituharu's emacs-mac port.
#+BEGIN_SRC emacs-lisp
(use-package doom-themes
  ...
  (defun cm/appearance-change-hook ()
    (let ((appearance (plist-get (mac-application-state) :appearance)))
      (cond ((equal appearance "NSAppearanceNameAqua")
             (cm/switch-theme light-mode-theme))
            ((equal appearance "NSAppearanceNameDarkAqua")
             (cm/switch-theme dark-mode-theme)))))

  (add-hook 'after-init-hook 'cm/appearance-change-hook)
  (add-hook 'mac-effective-appearance-change-hook 'cm/appearance-change-hook))
