...
{
    imports = [
      inputs.self.homeModules.emacs-config
    ];
    ...
    home.packages = with pkgs; [
      ...
      # Emacs via twist
    #   inputs.self.packages.${pkgs.stdenv.system}.emacs-env
    # ] ++ inputs.self.packages.${pkgs.stdenv.system}.emacs-config.buildInputs;

    # home.file.".emacs.d" = {
    #   source = inputs.self.packages.${pkgs.stdenv.system}.emacs-config;
    #   recursive = true;
    # };
    programs.emacs-config.enable = true;
    ...
    # NOTE: my emacs configuration is composed into a package.
    #       see flake.nix & configurations/emacs for more info.
    # programs.emacs-twist = {
    #   enable = true;
    #   wrapper = inputs.self.packages.${pkgs.stdenv.system}.emacs-env.emacsWrapper;
    #   emacsclient.enable = true;
    #   config = inputs.self.packages.${pkgs.stdenv.system}.emacs-env;
    #   directory = ".local/share/emacs";
    #   createInitFile = false;
    #   createManifestFile = false;
    # };
