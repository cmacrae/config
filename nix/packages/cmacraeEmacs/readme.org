...
*** Theme | Modeline
**** theme
Colour scheme is managed system-wide by [[https://github.com/danth/stylix][stylix]], so we just inherit that :)
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
;; TODO: uncomment when we get around the nix build issue
